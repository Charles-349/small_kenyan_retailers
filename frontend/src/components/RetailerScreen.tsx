...
export default function RetailerScreen() {
        ...
        try {
            ...
            setError(
                err instanceof Error
                    ? err.message
                    : "We couldn't create the delivery. Please try again.",
            );
        } finally {
            setSubmitting(false);
        }
    ...
    const trackingToken = lastCreated?.trackingToken;
    ...
    const copyTrackingLink = async () => {
        ...
        try {
            ...
            setError(
                "Unable to copy the tracking link. Please copy it manually.",
            );
        }
    };
        ...
        <section className="screen-modern">
            <div className="page-heading">
                <div>
                    ...
                    <p>
                        Request a rider in under a minute and
                        share live tracking with your customer.
                    </p>
                </div>
            ...
            <div className="retailer-grid">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="field-modern">
                            ...
                            <textarea
                                ...
                                placeholder="e.g. Call the customer on arrival."
                                rows={2}
                            />
                        </div>
                ...
                <div className="side-stack">
                    ...
                    <div className="panel reassurance">
                        ...
                        <div>
                            <strong>
                                Customer gets a live link
                            </strong>

                            <p>
                                Once the delivery is created,
                                a tracking link can be shared
                                with the customer. No app or
                                account needed.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="success-copy">
                        ...
                        {lastCreated.status && (
                            <span className="status-pill status-OPEN">
                                {lastCreated.status.toUpperCase()}
                            </span>
                        )}
                    </div>
